...
REST_FRAMEWORK = {
    ...
    "DEFAULT_RENDERER_CLASSES": (
        "apps.common.renderers.EnvelopedJSONRenderer",
    ...
    "EXCEPTION_HANDLER": "apps.common.exceptions.enveloped_exception_handler",
}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "FACTURYAN API",
    "DESCRIPTION": "API SaaS ERP de facturação electrónica com conformidade AGT.",
    "VERSION": "1.0.0",
